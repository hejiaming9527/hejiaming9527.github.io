...
> 以下内容包括大学课程设计与个人学习实践。课程设计由小组合作完成，并非个人独立开发；所有描述均按本人实际参与的技术工作整理。
...
- 使用 Python 面向公开网页信息完成请求、HTML 解析、字段提取与 DataFrame 整理；对重复链接、缺失字段和不规范日期进行检查与清洗。
- 使用 Pandas 进行分类与时间维度的基础统计，并通过 Matplotlib 输出柱状图、折线图等可视化结果；记录异常页面与请求状态，便于复盘数据质量问题。
